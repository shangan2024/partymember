		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="学号" prop="student_id">
							  ...
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','student_id')) || (!form_sub['ordinary_users_id'] && $check_field('add','student_id'))"></el-input>
				...
				<el-form-item label="年级班级" prop="grade_class">
							  ...
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','grade_class')) || (!form_sub['ordinary_users_id'] && $check_field('add','grade_class'))"></el-input>
					<div v-else-if="$check_field('get','grade_class')">{{form_sub['grade_class']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','political_outlook') || $check_field('add','political_outlook') || $check_field('set','political_outlook')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="政治面貌" prop="political_outlook">
								<el-select id="political_outlook" v-model="form_sub['political_outlook']"
						v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','political_outlook')) || (!form_sub['ordinary_users_id'] && $check_field('add','political_outlook'))">
						<el-option v-for="o in list_political_outlook" :key="o" :label="o" :value="o">
						</el-option>
					</el-select>
					<div v-else-if="$check_field('get','political_outlook')">{{form_sub['political_outlook']}}</div>
							</el-form-item>
			</el-col>
				...
				<el-form-item label="院别" prop="hospital">
						...
						v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','hospital')) || (!form_sub['ordinary_users_id'] && $check_field('add','hospital'))">
			...
			return {
				...
				disabledObj:{
								"student_id_isDisabled": false,
										...
										"political_outlook_isDisabled": false,
