<template>
	<div class="diy_list page_party_building_activities" id="party_building_activities_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">党建活动列表</span>
					</div>
				</div>
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
						<list_party_building_activities :list="list" />
						<!-- /列表 -->
					</div>
				</div>
